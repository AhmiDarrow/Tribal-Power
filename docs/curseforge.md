...
Same display-name style as 8828297: `Tribal Power 3.2.0 - The Listening Pit and the Gates`. Changelog is the short bullet form in `docs/RELEASE_3.2.0.md`. Upload `tribalpower-3.2.0.jar` for 1.21.1 / NeoForge / Client+Server, release. This is the cleaner 3.1 jar under a new version so CurseForge can process a new file.
