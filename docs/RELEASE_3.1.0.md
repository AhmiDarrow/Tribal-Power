...
- **Sounds**: original short hits for the Drumheart, the new generators, the mesh, the font, chalk and the gates. A **Drum Circle** music disc plays in a jukebox: one sits in a chest at the circle, and The Unsung carries another.
