...
/** A moss-green saddlebag panel, drawn with fills in the same quiet style as {@link StationScreen}. */
public class MossbackScreen extends AbstractContainerScreen<MossbackMenu> {
    public MossbackScreen(MossbackMenu menu,Inventory inventory,Component title) {
        super(menu,inventory,title);imageWidth=176;imageHeight=145;inventoryLabelY=51;
    }
    @Override protected void renderBg(GuiGraphics g,float partialTick,int mouseX,int mouseY) {
        int x=leftPos,y=topPos;
        g.fill(x,y,x+176,y+145,0xFF101B22);
        g.renderOutline(x,y,176,145,0xFFB58A58);
