...
public final class GuidePages {
    ...
    public static List<String> allPages() {
        return List.of(
                ...
                "WHAT YOU BUILD\n\nDrumheart, Ley, and Pulse Resonator for Pulse. Totem ring and Song Bench for songs. Echo shrine markers for camp layout. Pedestal for seals. Pulse Cells for Spiritgear. Gate Drum for The March.",
                "SPIRIT PULSE\n\nSpirit Pulse (SP) is measured in beats. Machines implement Pulse handlers. Early power comes from the Drumheart — strike it, or feed it redstone tempo. Ley Collectors sip ambient Pulse; Pulse Resonators burn coal for denser beats.",
                "READING PULSE\n\nDrumheart, Ley, and Resonator chat feedback show buffer fill. Song Bench status reports Pulse stalls. Nothing here speaks FE or RF natively.",
                ...
                "CHARGING CELLS\n\nHold a Pulse Cell and use it on a Drumheart or Pulse Resonator. Up to 25 Pulse transfers per click. Cells hold 200, stack to one, and show a cyan fill bar.",
                ...
                "LEY COLLECTOR\n\nGathers ambient Pulse (~2 every 40 ticks). Right-click to read its buffer. Song Bench drinks from Drumhearts, Ley Collectors, and Pulse Resonators first, then Totem buffers.",
                "PULSE RESONATOR\n\nBurns coal or charcoal into Spirit Pulse (~4 every 20 ticks while lit; ~1600 burn ticks per fuel). Right-click with fuel to load, empty-hand for status, shift-click to pull unused fuel. Lights while burning. Lattice Conductors treat it as a generator.",
                ...
                "LATTICE CONDUCTOR\n\nPlace near chalk-linked Resonance Totems. Right-click to read network size and push Pulse from nearby Drumhearts / Ley Collectors / Pulse Resonators into linked totem buffers. While powered, it assists Song Benches on the lattice and can move Echo grit between benches and Ancestral Caches.",
                ...
                "SAFETY\n\nPulse is not Redstone Flux. Do not expect FE cables to feed a Song Bench. Native rhythm remains Pulse — burn coal in a Resonator when ley is thin.",
