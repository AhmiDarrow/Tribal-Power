...
public record LatticeRecipe(String station, Ingredient ingredient, ItemStack output, int seconds, int pulse, Attunement attunement) implements Recipe<SingleRecipeInput> {
    ...
    private static final Codec<String> STATION = Codec.STRING.validate(value -> java.util.Set.of("echo_shatter","echo_attune","echo_bind","echo_manifest","echo_unweave","ember_kiln").contains(value)
